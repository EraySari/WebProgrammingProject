...
namespace WebProject.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.User.Include(u => u.Ucak);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserID,UserName,FirstName,LastName,Email,KoltukNo,Password,UcakID")] User user)
        {
            if (id != user.UserID)
            {
                return NotFound();

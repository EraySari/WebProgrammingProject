...
namespace WebProject.Data.Migrations
{
    ...
    [Migration("20231221160123_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebProject.Models.Ucak", b =>
                {
            ...
            modelBuilder.Entity("WebProject.Models.UserDetail", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("UFirstLastName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebProject.Models.UserDetail", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebProject.Models.User", b =>
                {
                    b.HasOne("WebProject.Models.Ucak", "Ucak")
                        .WithMany("Users")
